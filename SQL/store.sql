...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Jun 20, 2020 at 03:45 AM
...
(2, 'Shivansh Sagar', 'shivanshsagar00@gmail.com', 'c33367701511b4f6020ec61ded352059', '7858036722', 'Muzaffarpur', 'Vill- Chakmohabbat(Chankyapuri) Post- Bhikhanpur, Bara Jagarnath');
...
CREATE TABLE IF NOT EXISTS `users_items` (
  ...
  `status` enum('Added To Cart','Confirmed') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `item_id` (`item_id`)
